...
"31st May 2025 - Shift1": [
 ...
 "06th Sep 2024 - Shift2": [
  ...
  {
    "q": "भारत सरकार ने निम्नलिखित में से किस नदी को ‘राष्ट्रीय नदी’ के रूप में घोषित करने का निर्णय लिया है?",
    "options": [
      "1. गंगा",
      "2. यमुना",
      "3. ब्रह्मपुत्र",
...
let timerDuration = 06 * 60; // 06 minutes in seconds
let timerInterval;
...
fetch("https://script.google.com/macros/s/AKfycbze217vEXKA0PSGSa0Et7e9-bNhgNhNq_bCLES3wKfL8ZxUdt4JyHnp3LAJ-_rRgmmCEw/exec", {
  method: "POST",
  headers: { "Content-Type": "application/x-www-form-urlencoded" },
  body: `name=${encodeURIComponent(name)}&examDate=${encodeURIComponent(exam)}&score=${encodeURIComponent(fullScore)}`
});
