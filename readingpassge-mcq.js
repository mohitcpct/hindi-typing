 ...
 demo1: {
  ...
  {
    "q": "निम्‍नलिखित में से कौन-सा विकल्‍प कहानी का सही अनुक्रम देता है?<br>a. गरीब रोगी की दयनीय हालत देखकर डॉक्‍टर परेशान हो गए।<br>b. डॉक्‍टर ने गरीब मरीज की पत्नी को दवा का बॉक्‍स दिया और उसे नियमित रूप से इस्तेमाल करने को कहा।<br>c. चूंकि डॉ. मधुकर के ज्यादातर मरीज गरीब थे, उन्होंने उनसे शायद ही कोई शुल्‍क लिया था।<br>d. डॉक्‍टर ने महिला को जो दवा दी थी वह पैसे थे।",
    "options": [
      "1. dbca",
      "2. acbd",
      "3. cabd",
    ...
    "answer": 3
        ...
        english: {
          ...
          questions: [
            ...
            { q: "Which of the following options gives the correct sequence of the story? <br>a. The doctor was upset on seeing the pathetic condition of the poor patient.<br> b. He gave the poor patient’s wife a box of medicine and told her to use it regularly. <br> c. As Dr. Madhukar's patients were mostly poor, he hardly took any fee from them. <br> d. The medicine the doctor had given the woman was money. ", options: ["dbca", "acbd", "cabd", "dabc"], answer: 2 }
          ]
        }
      },
demo2: {
...
window.onload = () => {
  ...
  document.getElementById("username").addEventListener("input", validateInputs);
  document.getElementById("dateSelect").addEventListener("change", validateInputs);
  document.getElementById("btn-hi").classList.add("active");  // यह जोड़ें
  lang = "hindi";  // यह सुनिश्चित करें
  validateInputs();
};
...
function loadDates() {
  ...
  for (let key in questionBank) {
    ...
    opt.value = key;
    opt.textContent = questionBank[key].label;
...
function validateInputs() {
  const name = document.getElementById("username").value.trim();
  const date = document.getElementById("dateSelect").value;
  document.getElementById("startBtn").disabled = !(name && date);
}
...
function startTest() {
  ...
  if (!name || !date) {
    alert("कृपया नाम और परीक्षा दिनांक दोनों दर्ज करें।");
    return;
  }
  lang = document.getElementById("btn-hi").classList.contains("active") ? "hindi" : "english";

  document.getElementById("startSection").style.display = "none";
  document.getElementById("testSection").style.display = "block";
  document.getElementById("timerToggle").checked = true;

  loadQuestionsByDate(date);  // ✅ Fix: अब date पास कर रहे हैं
  toggleTimer();
}
...
function loadQuestionsByDate(key) {
...
function renderQuestion() {
  ...
  document.getElementById("passagePanel").innerText = passage;

  let html = `<div class='question-number'>${lang === "hi" ? "प्रश्न संख्या" : "Question No"}: ${currentQ + 1}</div>`;
  ...
  html += `</div>`;
  document.getElementById("singleQuestionPanel").innerHTML = html;
  updateNextButton();
  renderGrid();
  updateLangButtons();
}
...
function updateNextButton() {
  ...
  lang = selectedLang === "hi" ? "hindi" : "english";
  updateLangButtons();
  const date = document.getElementById("dateSelect").value;
  if (date) loadQuestionsByDate(date);
}
